        ...
        <div className="flex flex-col lg:flex-row h-auto lg:h-16 py-3 lg:py-0 items-center justify-between gap-4">
          <div className="flex items-center justify-between w-full lg:w-auto">
            ...
            <div className="flex lg:hidden items-center gap-2">
              <Link
                href="/wishlist"
                className="relative inline-flex h-10 w-10 items-center justify-center text-ink hover:text-primary"
              >
              ...
              <button
                ...
                className="inline-flex h-10 w-10 items-center justify-center text-ink hover:text-primary"
              >
          ...
          >
            <div className="relative w-full flex items-center">
              <Search
                className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-ink-subtle"
                aria-hidden
              />
              <input
                type="text"
                ...
                className="w-full h-10 pl-10 pr-4 text-sm bg-white/60 border border-surface-border rounded-full placeholder:text-ink-subtle focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all"
              />
            </div>
          </form>
          ...
          <div className="hidden lg:flex items-center gap-6 shrink-0">
            ...
            <div className="flex items-center gap-3">
              {user ? (
                <div className="relative">
                  <button
                    ...
                    className="inline-flex h-10 items-center justify-center text-ink hover:text-primary"
                  ...
                  {openUser && (
                    <div className="absolute right-0 mt-2 w-56 rounded-2xl border border-surface-border bg-white shadow-smooth-lg overflow-hidden">
                      ...
                      <div className="py-2">
                        <Link
                          href="/orders"
                          className="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-ink hover:bg-surface-muted"
              ...
              <Link
                href="/wishlist"
                className="relative inline-flex h-10 items-center justify-center text-ink hover:text-primary"
              >
                <Heart className="h-5 w-5" />
              </Link>
          ...
          <div className="lg:hidden py-4 space-y-4 border-t border-surface-border">
            ...
            >
              <div className="relative w-full flex items-center">
                ...
                <input
                  ...
                  name="search"
                  placeholder="Search…"
                  className="w-full h-10 pl-10 pr-4 text-sm bg-white/60 border border-surface-border rounded-full focus:bg-white focus:border-primary outline-none"
                />
              </div>
            </form>
            <nav className="space-y-1">
              <Link
                ...
                className="block px-4 py-3 rounded-xl text-sm font-semibold text-ink hover:bg-surface-muted transition-colors"
              >
                Home
              </Link>
              <Link
